...
//import android.support.v4.LocalBroadcastManager;
...
public class DatecsSDKWrapper {
    private static final String LOG_TAG = "Datecs_BluetoothPrinter";
    private Printer mPrinter;
    private ProtocolAdapter mProtocolAdapter;
    private BluetoothSocket mBluetoothSocket;
    private boolean mRestart;
    private String mAddress;
    private MethodChannel.Result mConnectResult;
    ...
    public DatecsSDKWrapper(Activity _activity) {
       activity = _activity;
     ...
     * @param result
     */
    protected void getBluetoothPairedDevices(MethodChannel.Result result) {
        BluetoothAdapter mBluetoothAdapter = null;
        try {
            mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
            if (mBluetoothAdapter == null) {
                result.error("ERROR", this.getErrorByCode(1).toString(), "");
                return;
            }
            ...
            if (pairedDevices.size() > 0) {
                ...
                result.error("ERROR", this.getErrorByCode(2).toString(), this.getErrorByCode(2));
            }
        } catch (Exception e) {
            Log.e(LOG_TAG, e.getMessage());
            e.printStackTrace();
...
//    }
     ...
     * @param result
     */
    public void setCallbackContext(MethodChannel.Result result) {
        mResult = result;
    }
     ...
     * @param result
     */
    protected void connect(MethodChannel.Result result) {
        mConnectResult = result;
        closeActiveConnections();
        if (BluetoothAdapter.checkBluetoothAddress(mAddress)) {
            establishBluetoothConnection(mAddress, result);
        }
    }
     ...
     * @param result
     */
    private void establishBluetoothConnection(final String address, final MethodChannel.Result result) {
        ...
        runJob(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    mBluetoothSocket = createBluetoothSocket(device, uuid, result);
                    Thread.sleep(50);
                    ...
                    try {
                        ...
                        ex.printStackTrace();
                        result.error("ERROR", sdk.getErrorByCode(18, ex).toString(), sdk.getErrorByCode(18, ex).toString());
                        return;
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                    result.error("ERROR", sdk.getErrorByCode(18, e).toString(),sdk.getErrorByCode(18, e));
                    return;
                }

                try {
                    initializePrinter(in, out, result);
                    showToast(DatecsUtil.getStringFromStringResource(app, "printer_connected"));
                    sendStatusUpdate(true);
                } catch (IOException e) {
                    e.printStackTrace();
                    result.error("ERROR", sdk.getErrorByCode(20).toString(), sdk.getErrorByCode(20));
                    return;
                }
            }
     ...
     * @throws IOException
     */
    private BluetoothSocket createBluetoothSocket(BluetoothDevice device, UUID uuid, final MethodChannel.Result result) throws IOException {
        try {
            ...
            result.error("ERROR", this.getErrorByCode(19).toString(), this.getErrorByCode(19));
     ...
     * @throws IOException
     */
    protected void initializePrinter(InputStream inputStream, OutputStream outputStream, MethodChannel.Result result) throws IOException {
    ...
    public void feedPaper(int linesQuantity) {
        if (linesQuantity < 0 || linesQuantity > 255) {
            mResult.error("ERROR", this.getErrorByCode(3).toString(), this.getErrorByCode(3));
        }
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(4, e).toString(), this.getErrorByCode(4, e));
        }
    }
    ...
    public void printTaggedText(String text, String charset) {
        try {
            ...
            e.printStackTrace();
            Log.e(LOG_TAG, e.getMessage());
            mResult.error("ERROR", this.getErrorByCode(5, e).toString(),this.getErrorByCode(5, e));
        }
    }
    ...
    public void write(byte[] b) {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(21, e).toString(),this.getErrorByCode(21, e));
        }
    }
    ...
    public void getStatus() {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(6, e).toString(), this.getErrorByCode(6, e));
        }
    }
    ...
    public void getTemperature() {
        try {
            ...
            mResult.success(temperature);
        } catch (Exception e) {
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(7, e).toString(), this.getErrorByCode(7, e));
        }
    }
    ...
    public void setBarcode(int align, boolean small, int scale, int hri, int height) {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(10, e).toString(), this.getErrorByCode(10, e));
        }
    }
    ...
    public void printBarcode(int type, String data) {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(8, e).toString(), this.getErrorByCode(8, e));
        }
    }
    ...
    public void printQRCode(int size, int eccLv, String data) {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(22, e).toString(), this.getErrorByCode(22, e));
        }
    }
    ...
    public void printSelfTest() {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(9, e).toString(), this.getErrorByCode(9, e));
        }
    }
    ...
    public void drawPageRectangle(int x, int y, int width, int height, int fillMode) {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(12, e).toString(), this.getErrorByCode(12, e));
        }
    }
    ...
    public void drawPageFrame(int x, int y, int width, int height, int fillMode, int thickness) {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(16, e).toString(), this.getErrorByCode(16, e));
        }
    }
    ...
    public void selectStandardMode() {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(13, e).toString(), this.getErrorByCode(13, e));
        }
    }
    ...
    public void selectPageMode() {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(14, e).toString(),this.getErrorByCode(14, e));
        }
    }
    ...
    public void printPage() {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(17, e).toString(),this.getErrorByCode(17, e));
        }
    }
    ...
    public void setPageRegion(int x, int y, int width, int height, int direction) {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(15, e).toString(),this.getErrorByCode(15, e));
        }
    }
    ...
    public void printImage(String image, int width, int height, int align) {
        try {
            ...
            e.printStackTrace();
            mResult.error("ERROR", this.getErrorByCode(11, e).toString(),this.getErrorByCode(11, e));
        }
    }
